            ...
            <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p class="mt-3 text-lg text-black">
                  ...
                  optimizing operations, integrating innovative technologies,
                  and receiving personalized support.
                </p>
                  ...
                  <div class="flex">
                    ...
                    <div class="ml-4">
                      ...
                      <p class="mt-2 text-black">
                        ...
                        boosting efficiency and profitability. Make data-driven
                    ...
                    <div class="flex">
                      ...
                      <div class="ml-4">
                        ...
                        <p class="mt-2 text-black">
                          ...
                          functionalities. Adapt to market dynamics and gain a
          ...
          <div class="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            ...
            <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              ...
              <div ref={ref}>
                <motion.div
                  variants={{
                    hidden: { opacity: 0, x: 65, filter: "blur(4px)" },
